...
Konrad Stopsack- none.

Travis Gerke- cStructure...
...
Konrad Stopsack (BIPS)<br />*Epidemiologic research*
...
Travis Gerke (PCCTC/cStructure)<br />*Clinical trials/Startup*
...
Emily Riederer (Capital One)<br />*Finance*
...
Malcolm Barrett (Stanford)<br />*Research/programming*
...
# Use Case 1<br />No more hand-typed numbers -- Epidemiologic results tables in 2025
...
## Sensivity analyses made easy {.smaller}
...
## Stratified analyses and regression analyses at once {.smaller}
...
## Different exposure? No problem<br />[R, could you round meaningfully for us? Certainly]{.fragment fragment-index=7}{.smaller}
...
* Excel calculator **Episheet**<br />by Kenneth Rothman

* R package **gtsummary**<br />by Daniel Sjoberg

* Many others, of varying quality
...
::: aside
Ahrens W *et al.* The IDEFICS cohort: design, characteristics and participation in the baseline survey. *Int J Obes.* 2011;35:S3-S15.<br />Ahrens W *et al.* Cohort profile: The transition from childhood to adolescence in European children -- How I.Family extends the IDEFICS cohort. *Int J Epidemiol.* 2017;46:1394-1395.
:::
...
## Estimating and reporting adjusted risk ratios and risk differences made easy {.smaller}
...
[**Feel free to reach out about this opportunity and others.**]{.blue}
...
:::
:::{.column width=45%}
![](img/csm_bips_building-front-02_5a53a95a19.jpg)
![](img/map-Bremen-Europe.png)
:::
::::
